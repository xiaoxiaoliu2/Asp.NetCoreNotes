...
using ServiceContracts;   // controller fetch the data from a reusable service from the business model
using System;
...
namespace Services
{
    ...
    {
        // add code for saving the data to the controller, which may include with business logic
