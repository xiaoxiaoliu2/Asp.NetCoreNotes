...
{
    public class WeatherController : Controller    // Views/Weather
    {
    ...
    new CityWeather() { CityUniqueCode = "PAR", CityName = "Paris", DateAndTime = Convert.ToDateTime("2030-01-01 9:00"), TemperatureFahrenheit = 82 }
        ...
        public IActionResult City(string? cityCode)
        {
            ...
            {
                //send null as model object to "Views/Weather/Index.cshtml" view
                return View();     
            }
            ...
            //send matching city object to "Views/Weather/City.cshtml" view
            return View(city);
        }
    }
}